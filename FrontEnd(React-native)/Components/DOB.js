    ...
    return (
      <View style={{flex:1,backgroundColor:'white'}}>
        ...
        <View>
            <View style={{marginLeft:size(20)}}>
                <Text style={{fontSize:size(40),color:'black',fontFamily:'Signika-Regular'}}>Perfect {name} Please go ahead with your Date Of Birth</Text>
            </View>
      ...
      <FAB
        ...
        onPress={()=>{
          ...
          navigation.navigate('refralCode');
